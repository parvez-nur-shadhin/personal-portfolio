...
const Banner = () => {
    ...
    return (
        <div id='about' className='max-w-277.5 mx-auto flex flex-col-reverse md:flex-row justify-between items-center mt-5 md:mt-20 p-4'>
            {/* Left */}
            <div className='text-center md:text-start mt-5 md:mt-0'>
                ...
                <p className='max-w-150 text-sm md:text-md mt-5 '>
            ...
            {/* right */}
            <div>
                <img className='w-50 md:w-75 border rounded-4xl shadow-2xl shadow-gray-700 transform transition duration-1000 hover:-translate-x-2 hover:-translate-y-2 hover:scale-120 hover:3xl cursor-pointer' src={MyPicture} alt="" />
            </div>
        </div>
    );
};
