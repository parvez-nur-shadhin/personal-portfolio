...
const Navbar = () => {
  ...
  return (
    <nav className="w-full border-2 p-4 flex justify-between items-center sticky top-0 z-10">
      {/* Left */}
      <div className="flex justify-center items-center gap-4">
        ...
        <div
          className={`space-y-6 absolute left-5 ${open ? "top-20" : "-top-60"} transitionAll duration-1000 backdrop:blur-lg bg-black/30`}
        >
